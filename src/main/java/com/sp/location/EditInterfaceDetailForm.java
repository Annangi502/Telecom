...
public class EditInterfaceDetailForm extends Panel {
	...
	public EditInterfaceDetailForm(String id, final IModel<NetworkInterfaceDetail> nidmodel,
		...
		/*
		 * spntinterface = nid.getSpntinterface(); spipaddress =
		 * nid.getSpipaddress(); spsubnetmask = nid.getSpsubnetmask();
		 */
		asnumber = nid.getAsnumber();
		lanspntinterface = nid.getLanspntinterface();
		lanspipaddress = nid.getLanspipaddress();
		lanspsubnetmask = nid.getLanspsubnetmask();
	...
	private boolean editNetworkInterfaceDetail() {
		...
		try {
			...
			stmt.setString(13, lanspntinterface);
			stmt.setString(14, lanspipaddress);
			stmt.setString(15, lanspsubnetmask);
			stmt.setString(16, remark);
			stmt.setInt(17, nid.getInterfaceid());
	...
	public List<NetworkVendorDetail> getVendors() {
		...
		try {
			...
			while (rs.next()) {
				NetworkVendorDetail nvd = new NetworkVendorDetail(rs.getInt(1), rs.getString(2), rs.getString(3),
						rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8),
						rs.getString(9), rs.getInt(10), rs.getString(11), rs.getInt(12), rs.getString(13),
