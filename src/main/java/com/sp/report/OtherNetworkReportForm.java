...
public class OtherNetworkReportForm extends Panel {
	private static final Logger log = Logger.getLogger(OtherNetworkReportForm.class);
	...
	public OtherNetworkReportForm(String id) {
		super(id);
		setDefaultModel(new CompoundPropertyModel<OtherNetworkReportForm>(this));
